...
class ClearEntities extends PluginBase implements Listener{
	...
	public function onEntitySpawn(EntitySpawnEvent $event){
		$e = $event->getEntity();
		if(($e instanceof Item && $this->ce["Item"] < 300) || ($e instanceof Arrow && $this->ce["Item"] < 60)) $this->getServer()->getScheduler()->scheduleDelayedTask(new CallbackTask([$this,"kill"], [$e]), $this->ce[$e instanceof Item ? "Item": "Arrow"] * 20);
	}
	...
	public function loadYml(){
		...
		$this->ce = (new Config($this->getServer()->getDataPath() . "/plugins/! MineBlock/" . "ClearEntities.yml", Config::YAML, ["Item" => 60,"Arrow" => 10]))->getAll();
	}

	public function saveYml(){
		$ce = new Config($this->getServer()->getDataPath() . "/plugins/! MineBlock/" . "ClearEntities.yml", Config::YAML, ["Item" => 60,"Arrow" => 10]);
		$ce->setAll($this->ce);
		$ce->save();
	}
