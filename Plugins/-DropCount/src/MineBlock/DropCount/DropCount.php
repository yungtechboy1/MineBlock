...
class DropCount extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->set = (new Config($this->getServer()->getDataPath() . "/plugins/! MineBlock/" . "DropCount.yml", Config::YAML, ["Count" => "1~1"]))->getAll();
	}

	public function saveYml(){
		$set = new Config($this->getServer()->getDataPath() . "/plugins/! MineBlock/" . "DropCount.yml", Config::YAML, ["Count" => "1~1"]);
		$set->setAll($this->set);
		$set->save();
	}
