...
class Check extends PluginBase implements Listener{
	...
	public function onEnable(){
		$this->getServer()->getLogger()->info("[Check] Find economy plugin...");
		$pm = $this->getServer()->getPluginManager();
 		if(!($this->money = $pm->getPlugin("PocketMoney")) && !($this->money = $pm->getPlugin("EconomyAPI")) && !($this->money = $pm->getPlugin("MessiveEconomy")) && !($this->money = $pm->getPlugin("Money"))){
			$this->getServer()->getLogger()->info("[Check] Failed find economy plugin...");
			...
			$this->getServer()->getLogger()->info("[Check] Finded economy plugin : ".$this->money->getName());
		}
		$this->touch = [];
